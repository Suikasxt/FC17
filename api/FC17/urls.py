...
urlpatterns = [
    ...
    path('api/leaderboard/total/', api_team.leaderboard),
    path('api/leaderboard/daily/', api_ai.leaderboard),
    ...
    path('api/ai_test/upload/', api_ai.upload_test),
    path('api/leaderboard_test/daily/', api_ai.leaderboard_test),
]
